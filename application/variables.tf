...
locals {
  ...
  container_environment_name = "${local.environment_shortcode}-${var.domain}-ace-${local.region_shortcode}-${var.unique_namespace}"
  log_analytics_name         = "${local.environment_shortcode}-${var.domain}-la-${local.region_shortcode}-${var.unique_namespace}"
